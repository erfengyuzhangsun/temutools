...
def show_landing_page():
    ...
    with col_faq1:
        ...
        faq_data = [
            ...
            ("Q: 数据安全吗？", "A: ✅ <strong>绝对安全！</strong> 所有数据仅在您的本地浏览器处理，<strong>不会上传到我们的服务器</strong>。您的数据完全由您自己掌控。"),
            ("Q: 费用规则会更新吗？", "A: ✅ 是的！我们<strong>每周更新</strong> Temu 最新费用规则，确保计算结果始终准确。这是我们的核心竞争力之一！"),
            ("Q: 如何联系客服？", "A: 微信：<strong>returnHuangMuNing</strong> 或邮箱：<strong>484478363@qq.com</strong>，工作时间内 10 分钟内回复")
        ]
