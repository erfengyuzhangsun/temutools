...
SYNC_TABLES = {
    "temu_shop_credentials": """
        CREATE TABLE IF NOT EXISTS temu_shop_credentials (
            ...
            encrypted_api_key TEXT NOT NULL COMMENT '加密API Key(兼容旧版)',
            encrypted_api_secret TEXT NOT NULL COMMENT '加密API Secret(兼容旧版)',
            encrypted_access_token TEXT DEFAULT NULL COMMENT '加密Access Token(新版OAuth)',
